...
About
========================================
exompp_hello.py is a simple python script that demonstrates how to send data to
the Exosite One Platform over XMPP.
...
3) test it out
****************************************
get python script "exompp_hello.py" and "options.cfg"
--) update the default credentials in options.cfg to use your xmpp login and 
    device CIK
--) run the script (> python exompp_hello.py)
--) verify the app connects, creates a datasource and sends data (no errors 
    should be generated)
--) log into one.exosite.com and verify the data source is created and that 
    data was generated
